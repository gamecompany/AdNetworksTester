...
#if UNITY_ANDROID
    // App ID
    appId= "app6028114be9254681a3";
    // Video zones
    AddZoneToManager("VideoZone1", "vz43fbf036355f436e8c", ADCVideoZoneType.Interstitial);
    AddZoneToManager("VideoZone2", "vzfa81887634db40e884", ADCVideoZoneType.Interstitial);
    // V4VC zones
    AddZoneToManager("V4VCZone1", "vz30d0f8b42f7f4045a4", ADCVideoZoneType.V4VC);
